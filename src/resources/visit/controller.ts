...
const getAllVisitHistory = async (req: Request, res: Response, next: NextFunction) => {
  try {
...
const getVisitHistoryByAppointmentDate = async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { date } = req.params;
